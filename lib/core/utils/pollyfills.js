...
if (typeof Node === 'object' && !Object.prototype.hasOwnProperty.call(Node.prototype, 'getRootNode')) {
	Object.defineProperty(Node.prototype, 'getRootNode', {
		enumerable: false,
		configurable: false,
		value: function () {
			// NOTE: This is ignoring the composed argument.
			// Browsers that don't have getRootNode don't have shadowDOM
			let root = this;
			let count = 0;
			while (root.parentNode) {
				root = root.parentNode;
				if (count++ > 99999) {
					throw new Error('Infinite loop encountered trying running getRootNode')
				}
			}
			return root
		}
